...
Some training files are too large to be uploaded to GitHub. Backup copies are therefore stored in a separate file-sharing repository:

[Figshare Backup Repository](https://figshare.com/s/1193aa75f95b22929b20)

## Code Availability

We will open-source the model code after publication.
